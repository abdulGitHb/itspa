        ...
        <div className="container flex flex-col flex-1 px-6 py-12 mx-auto">
            <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
                <div className="text-white lg:w-1/2 lg:mx-6">
                    ...
                    <button className="px-8 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#616847] rounded-md hover:bg-[#C2C0A2] focus:outline-none focus:ring focus:ring-[#616847] focus:ring-opacity-50">
                        get in touch
                    </button>
